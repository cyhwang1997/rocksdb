...
class CVQFTest : public testing::Test {
 private:
 ...
 public:
  CVQFTest() : policy_(
      NewCVQFPolicy(FLAGS_bits_per_key)) {}

  ~CVQFTest() override { delete policy_; }
...
TEST_F(CVQFTest, EmptyFilter) {
  ASSERT_TRUE(! Matches("hello"));
  ASSERT_TRUE(! Matches("world"));
}

TEST_F(CVQFTest, Small) {
  Add("hello");
  Add("world");
  ASSERT_TRUE(Matches("hello"));
  ASSERT_TRUE(Matches("world"));
...
TEST_F(CVQFTest, VaryingLengths) {
  char buffer[sizeof(int)];
...
class FullCVQFTest : public testing::Test {
 private:
  const FilterPolicy* policy_;
