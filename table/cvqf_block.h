...
//
class CVQFBlockBuilder : public FilterBlockBuilder {
 public:
  explicit CVQFBlockBuilder(const SliceTransform* prefix_extractor,
 ...
 private:
  ...
  // No copying allowed
  CVQFBlockBuilder(const CVQFBlockBuilder&);
  void operator=(const CVQFBlockBuilder&);
};

// A FilterBlockReader is used to parse filter from SST table.
// KeyMayMatch and PrefixMayMatch would trigger filter checking
class CVQFBlockReader : public FilterBlockReader {
 public:
  // REQUIRES: "contents" and filter_bits_reader must stay live
  // while *this is live.
  explicit CVQFBlockReader(const SliceTransform* prefix_extractor,
                                 bool whole_key_filtering,
 ...
 private:
  ...
  // No copying allowed
  CVQFBlockReader(const CVQFBlockReader&);
  bool MayMatch(const Slice& entry);
  void operator=(const CVQFBlockReader&);
